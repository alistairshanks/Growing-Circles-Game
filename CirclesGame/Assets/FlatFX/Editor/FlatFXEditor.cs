...
public class FlatFXEditor:Editor{
	...
	private static void SetDefaultSettings(FlatFX instance) { 
		TextAsset jsonAsset=(TextAsset)Resources.Load("FlatFXSettingsDefault",typeof(TextAsset));
		JsonUtility.FromJsonOverwrite(jsonAsset.text,instance);
	}
    ...
    public override void OnInspectorGUI(){
		...
		#if UNITY_EDITOR
		//Ensures effects rendering in Editor when clicking "Test"
